...
public class Question9GUI extends javax.swing.JFrame {
	...
	public static void main(String args[]) {
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new Question9GUI().setVisible(true);
			}
		});
	}
